document.addEventListener('DOMContentLoaded', function() {
    ...
    var correctPassword = 'vanbao'; // Thay đổi thành mật khẩu của bạn
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    'music/doilong.mp3',
    'music/freedom.mp3',
    'music/nhungloinoidoi.mp3',
    'music/sixusav2.mp3',
    'https://thanhdieu.com/files/Em-N%C3%A0o-C%C3%B3-T%E1%BB%99i.mp3',
    'music/sontungchill.mp3',
    'music/nhacsex.mp3',
    'music/hanhlangcu.mp3',
    'music/nhactam.mp3',
    'music/nhactet2.mp3',
    'music/nhaccachmang.mp3',
    'music/bacphat.mp3',
    'music/nhactet.mp3',
    'music/future.mp3'
    ];
...
document.getElementById('contactButton').addEventListener('click', function() {
    window.location.href = 'https://t.me/vanbaoios'; // Thay đổi địa chỉ email nếu cần
});
